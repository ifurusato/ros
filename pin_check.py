...
def main():
    try:
        ...
        while True:
            ...
            print(INDENT + _pin19.get()                         + CYAN_NORMAL + '\t(19) | (20)\t' + GND + Style.RESET_ALL)
            print(INDENT + _pin21.get()                         + CYAN_NORMAL + '\t(21) | (22)\t' + _pin22.get() + Style.RESET_ALL)
            print(INDENT + _pin23.get()                         + CYAN_NORMAL + '\t(23) | (24)\t' + _pin24.get() + Style.RESET_ALL)
            print(INDENT + GND                                  + CYAN_NORMAL + '\t(25) | (26)\t' + _pin26.get() + Style.RESET_ALL)
            ...
            print('\n\n\n' + Fore.BLACK + _style + INDENT + Style.NORMAL + '\t{}  \tType Ctrl-C to exit.'.format(count) + Style.RESET_ALL)
